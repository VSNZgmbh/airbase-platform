        ...
        <View style={{ flexDirection: "row", gap: 10 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={[s.card, { marginBottom: 6 }]}>
              ...
              <Text style={{ fontSize: 7, color: C.textSecondary, lineHeight: 1.5 }}>
                Heavy-lift drone logistics is inherently local -- success depends on regional relationships, cantonal knowledge, and proximity to customers. Building this internally across 35+ regions would require years and CHF 5M+ CAPEX. Our strategic priority is speed: becoming the dominant Swiss brand before competitors emerge. The franchise model achieves national coverage in 4 years; own-operations-only would take 8-10. Partners invest their own capital, bring local expertise, and bear local risk. HQ earns ~14% recurring take rate with minimal incremental cost.
              </Text>
            </View>
            <View style={[s.card, { marginBottom: 6 }]}>
              <Text style={{ fontSize: 8, fontWeight: "bold", color: C.text, marginBottom: 3 }}>
                Do you have commercial traction or letters of intent?
              </Text>
              <Text style={{ fontSize: 7, color: C.textSecondary, lineHeight: 1.5 }}>
                We have active interest from Swiss construction firms and the Swiss Civil Defense (Zivilschutz), awaiting our operational launch. The value proposition drives itself: drone transport at CHF 2,800-5,000 per day vs. helicopter at CHF 15,000-25,000 -- a 5-8x cost reduction with zero emissions. Enterprise contract negotiations begin upon operational readiness in Q3/Q4 2026.
              </Text>
            </View>
            ...
            <View style={[s.card, { marginBottom: 6 }]}>
              ...
              <Text style={{ fontSize: 7, color: C.textSecondary, lineHeight: 1.5 }}>
                Through our partnership with Vertical Masters, an established Swiss drone operator. Their existing SORA approvals cover initial operations. We proactively submit multiple SORA applications to cover a broad service spectrum. If the LUC is delayed 12-18 months, franchise partners can begin operations in SORA-approved areas under Vertical Masters. Government and military retainers scale with the LUC timeline -- our DaaS business is unaffected.
              </Text>
            </View>
            <View style={[s.card, { marginBottom: 6 }]}>
              <Text style={{ fontSize: 8, fontWeight: "bold", color: C.text, marginBottom: 3 }}>
                How do you ensure safety compliance across franchise partners?
              </Text>
              <Text style={{ fontSize: 7, color: C.textSecondary, lineHeight: 1.5 }}>
                Every flight mission is planned by the airBASE AI platform and reviewed by a certified Safety Compliance officer before authorization. No drone launches without human sign-off. This dual-layer system (AI planning + human verification) ensures consistent compliance across all partners, regardless of location -- protecting both operational safety and our LUC certification.
              </Text>
            </View>
